"""M1.4 test: headkv_pack kernel correctness.
...
class TestHeadKVPack:
    def test_pack_single_segment_per_kind(self):
        ...
        _ops_mod.headkv_pack(mgr, src_kind_t, src_slot_global_t, seg_lengths_t, dst_token_offsets_t)
