"""M1.4 part 2 test: headkv_plan + headkv_pack end-to-end.

Manually populate manager pools + valid_count, call headkv_plan to build
descriptor tensors, run headkv_pack, verify the flat output equals the
...
class TestHeadKVPlan:
    def test_plan_then_pack_roundtrip(self):
        ...
        # Plan B — old headkv_plan packs all L layers in one call.
