...
> _headkv_plan_cuda(
    c10::intrusive_ptr<HeadKVCacheManager> mgr,
    int64_t current_t,
    int64_t pass_kind
);
...
// headkv_plan() helper. The kernel writes mgr.k_flat_out_ / v_flat_out_.
static void headkv_pack(
    c10::intrusive_ptr<adahead::HeadKVCacheManager> mgr,
    torch::Tensor src_kind,
    torch::Tensor src_slot_global,
    torch::Tensor seg_lengths,
    torch::Tensor dst_token_offsets,
    ...
    TORCH_CHECK(mgr.get() != nullptr, "headkv_pack: manager is null");
    adahead::launch_headkv_pack(
        mgr->sink_k_pool(),
        mgr->middle_k_pool(),
        mgr->recent_k_pool(),
        mgr->sink_v_pool(),
...
static void headkv_update(
    ...
    TORCH_CHECK(mgr.get() != nullptr, "headkv_update: manager is null");
    adahead::launch_headkv_update(
        new_k, new_v, new_pos,
...
static void headkv_update_meta(
    c10::intrusive_ptr<adahead::HeadKVCacheManager> /*mgr*/,
    torch::Tensor /*new_k*/,
    torch::Tensor /*new_v*/,
    torch::Tensor /*new_pos*/,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("refresh_readout_layout", &refresh_readout_layout,
          "Refresh mutable HeadKV readout layout segments (CUDA)");
    m.def("anchor_store_write_frames", &anchor_store_write_frames,
          "Write frame slices into contiguous HeadKV anchor-store slots (CUDA)");
}
...
TORCH_LIBRARY(adahead, m) {
    // HeadKVCacheManager custom class.
    // Plan B — constructor takes 10 args now (added max_attend_chunks at end).
    m.class_<adahead::HeadKVCacheManager>("HeadKVCacheManager")
        .def(torch::init<
            ...
            int64_t
        >())
        .def("reset", &adahead::HeadKVCacheManager::reset)
        .def("set_strategy", &adahead::HeadKVCacheManager::set_strategy)
        .def("sink_pool", &adahead::HeadKVCacheManager::sink_pool)
        .def("middle_pool", &adahead::HeadKVCacheManager::middle_pool)
        .def("recent_pool", &adahead::HeadKVCacheManager::recent_pool)
        .def("sink_k_pool", &adahead::HeadKVCacheManager::sink_k_pool)
        .def("sink_v_pool", &adahead::HeadKVCacheManager::sink_v_pool)
        .def("middle_k_pool", &adahead::HeadKVCacheManager::middle_k_pool)
        .def("middle_v_pool", &adahead::HeadKVCacheManager::middle_v_pool)
        .def("recent_k_pool", &adahead::HeadKVCacheManager::recent_k_pool)
        .def("recent_v_pool", &adahead::HeadKVCacheManager::recent_v_pool)
        .def("sink_pos_pool", &adahead::HeadKVCacheManager::sink_pos_pool)
        .def("middle_pos_pool", &adahead::HeadKVCacheManager::middle_pos_pool)
        .def("recent_pos_pool", &adahead::HeadKVCacheManager::recent_pos_pool)
        .def("head_t_table", &adahead::HeadKVCacheManager::head_t_table)
        .def("write_idx", &adahead::HeadKVCacheManager::write_idx)
        .def("valid_count", &adahead::HeadKVCacheManager::valid_count)
        .def("strategy", &adahead::HeadKVCacheManager::strategy)
        .def("k_flat_out", &adahead::HeadKVCacheManager::k_flat_out)
        .def("v_flat_out", &adahead::HeadKVCacheManager::v_flat_out)
        .def("cu_seqlens_k", &adahead::HeadKVCacheManager::cu_seqlens_k)
        .def("pos_flat_out", &adahead::HeadKVCacheManager::pos_flat_out)
        // merge pools
        .def("merge_k_pool", &adahead::HeadKVCacheManager::merge_k_pool)
        .def("merge_v_pool", &adahead::HeadKVCacheManager::merge_v_pool)
        .def("merge_pos_pool", &adahead::HeadKVCacheManager::merge_pos_pool)
        .def("merge_token_count", &adahead::HeadKVCacheManager::merge_token_count)
        .def("merge_accum_sum_k", &adahead::HeadKVCacheManager::merge_accum_sum_k)
        .def("merge_accum_sum_v", &adahead::HeadKVCacheManager::merge_accum_sum_v)
        .def("merge_accum_pos", &adahead::HeadKVCacheManager::merge_accum_pos)
        .def("merge_accum_group_ids", &adahead::HeadKVCacheManager::merge_accum_group_ids)
        .def("merge_accum_tokens_per_group",
             &adahead::HeadKVCacheManager::merge_accum_tokens_per_group)
        .def("merge_accum_num_groups",
             &adahead::HeadKVCacheManager::merge_accum_num_groups)
        .def("max_merge_blocks", &adahead::HeadKVCacheManager::max_merge_blocks)
        .def("max_merge_active", &adahead::HeadKVCacheManager::max_merge_active)
        .def("max_merge_tokens_per_anchor",
             &adahead::HeadKVCacheManager::max_merge_tokens_per_anchor)
        .def("num_layers", &adahead::HeadKVCacheManager::num_layers)
        .def("num_heads", &adahead::HeadKVCacheManager::num_heads)
        .def("head_dim", &adahead::HeadKVCacheManager::head_dim)
        .def("frame_seqlen", &adahead::HeadKVCacheManager::frame_seqlen)
        .def("max_sink", &adahead::HeadKVCacheManager::max_sink)
        .def("max_middle", &adahead::HeadKVCacheManager::max_middle)
        .def("max_recent", &adahead::HeadKVCacheManager::max_recent)
        .def("max_total", &adahead::HeadKVCacheManager::max_total)
        .def("max_total_tokens", &adahead::HeadKVCacheManager::max_total_tokens)
        // Plan B — new query: per-attend-call pack workspace capacity.
        .def("max_attend_chunks", &adahead::HeadKVCacheManager::max_attend_chunks)
        .def("max_pack_tokens", &adahead::HeadKVCacheManager::max_pack_tokens);
    ...
    m.def(
        "headkv_pack(__torch__.torch.classes.adahead.HeadKVCacheManager mgr, "
    ...
    m.def(
        "headkv_plan(__torch__.torch.classes.adahead.HeadKVCacheManager mgr, "
    ...
    m.def(
        "headkv_update(__torch__.torch.classes.adahead.HeadKVCacheManager mgr, "
    ...
    m.def(
        "mega_plan(__torch__.torch.classes.adahead.HeadKVCacheManager mgr, "
    ...
    m.def(
        "mega_plan_multi(__torch__.torch.classes.adahead.HeadKVCacheManager mgr, "
...
TORCH_LIBRARY_IMPL(adahead, CUDA, m) {
    ...
    m.impl("headkv_pack", headkv_pack);
    m.impl("headkv_update", headkv_update);
    m.impl("mega_state_update", mega_state_update);
    m.impl("mega_merge_accum", mega_merge_accum);
}

// headkv_plan has no Tensor args (only a custom class + ints), so the
...
TORCH_LIBRARY_IMPL(adahead, CompositeExplicitAutograd, m) {
    m.impl("headkv_plan", adahead::_headkv_plan_cuda);
...
TORCH_LIBRARY_IMPL(adahead, Meta, m) {
    ...
    m.impl("headkv_pack", headkv_pack_meta);
    m.impl("headkv_plan", adahead::_headkv_plan_meta);
    m.impl("headkv_update", headkv_update_meta);
