...
class HeadKVCacheManager : public torch::CustomClassHolder {
public:
    HeadKVCacheManager(
        int64_t num_layers,
        int64_t num_heads,
    ...
    // documented in headkv/cpp_strategy.py KIND_*. ``params`` is a small
