// M1.4 — HeadKVPlanInfo: serializable layout metadata for one block forward.
//
...
// (headkv_pack_kernel) reads the resulting device-side buffers without
...
struct HeadKVPlanInfo {
    ...
    static HeadKVPlanInfo FromMetaVector(
        ...
        TORCH_CHECK(v.size() == 9, "HeadKVPlanInfo meta vector must have 9 ints");
        HeadKVPlanInfo info;
