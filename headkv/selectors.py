...
should use :mod:`headkv.adaptive_cache` (per-head ``HeadComposition``)
instead.
"""
...
warnings.warn(
    "headkv.selectors is deprecated and will be removed in a future release; "
    "use headkv.adaptive_cache.AdaptiveKVCache with HeadComposition strategies "
    "instead.",
    DeprecationWarning,
    stacklevel=2,
)
